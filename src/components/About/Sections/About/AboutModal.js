  ...
  return (
    <Modal onClose={props.onClose}>
        <div className={classes.container}>
            ...
            <p>
                After those 5 years in the event industry, I decided to move to the UK. Once in London, I found a job in the hospitality industy in order to improve my English, then ended up I running 2 successfull resturants where I had to manage over 50 staff and look after the business. Even if I enjoyed the job, it felt like something was missing. 
            </p>
            <p>
                That is why last year, I decided to go back to university to study computer science. I graduated with distinction in 2022 with a license in computer science (focus in web development). During this year of study, I learned a several new technologies including python, javascript etc. and I was able to work on several projects (a online game, a bar app & many more) that you can see more in details in my portefolio.
